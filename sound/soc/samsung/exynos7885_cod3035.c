...
static struct snd_soc_dai_link exynos7885_dai[] = {
	...
	},
	{
		...
		.cpu_dai_name = "UAIF3",
		.platform_name = "snd-soc-dummy",
#if !defined(CONFIG_SND_SOC_TFA9872) && !defined(CONFIG_SND_SOC_TFA9896) && !defined(CONFIG_SND_SOC_SMA1301) && !defined(CONFIG_SND_SOC_TAS2562) && !defined(CONFIG_SND_SOC_SMA1303)
		.codec_name = "snd-soc-dummy",
		.codec_dai_name = "snd-soc-dummy-dai",
#endif
		.dai_fmt = SND_SOC_DAIFMT_I2S | SND_SOC_DAIFMT_NB_NF | SND_SOC_DAIFMT_CBS_CFS,
